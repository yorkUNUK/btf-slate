<h3 id="Get-Account-Trade-List-By-ClientOrderId" class="has-code" style="font-size:24px;font-family:'Helvetica',sans-serif;">
Get Account Trade List By CLientOrderId
</h3>

<strong style="color:#008756;font-size:1.25em">GET</strong> `https://api-pro.sim.hashkeydev.com/api/v1/account/tradesByClOrderId`
...
* This Endpoint is of lower weight comparing with [Get Account Trade List](#Get-Account-Trade-List)
