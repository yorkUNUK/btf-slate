<h3 id="Create-Order-v1" style="font-size:24px;font-family:'Helvetica',sans-serif;">
Create Order v1.0
</h3>   

<strong style="color:#0074e1;font-size:1.25em">POST</strong> `https://api-pro.sim.hashkeydev.com/api/v1/spot/order`

📘 **We provide two endpoints for creating spot trading orders:**<br/>
1. Legacy Endpoint: /api/v1/spot/order<br/>
2. New Endpoint: /api/v1.1/spot/order<br/>
...
**Recommendation:**
For enhanced functionality and flexibility, we strongly recommend using the new v1.1 endpoint (/api/v1.1/spot/order) for all order creations<br/>
[create-order-v1.1](#Create-Order-v1_1)
